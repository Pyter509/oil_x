...
<!-- jQuery (optional but often used with Bootstrap) -->
...
<script src="{{asset('admin/admin/js/chart.min.js')}}"></script>
...
<script src="{{asset('admin//am_chart/amcharts.js')}}"></script>
