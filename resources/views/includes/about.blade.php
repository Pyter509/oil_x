  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        ...
        <p class="text-secondary mb-5 text-center lead fs-4">We pride ourselves on delivering top-notch repair and maintenance solutions to Car Engines and Oil Exchange</p>
  ...
  <div class="container">
    <div class="row gy-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-4">
        <img class="img-fluid rounded border" loading="lazy" src="{{url('images/engine.jpeg')}}" alt="About Us">
      </div>
